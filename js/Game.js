class Game {
  ...
  start() {
    ...
    this.addSprites(obstacle2, obstacle2Positions.length, obs2, 0.04, obstacle2Positions);
  ...
  showLife() {
    push();
    image(lifeImage, width / 2 - 130, height - player.positionY - 231, 20, 20);
    fill("white");
    rect(width / 2 - 100, height - player.positionY - 231, 185, 20);
    fill("#f50057");
    rect(width / 2 - 100, height - player.positionY - 231, player.life, 20);
    noStroke();
    pop();
  }
